...
public class MainGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textureMenuItem = new javax.swing.JMenuItem();
        depthMapMenuItem = new javax.swing.JMenuItem();
        ...
        typePanel.add(dottedRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 120, -1));
        ...
        typePanel.add(texturedRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 120, -1));

        elementLabel.setText("Hidden element:");
        typePanel.add(elementLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 130, -1));
        ...
        typePanel.add(textRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 120, -1));
        ...
        typePanel.add(mapRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 120, -1));
        ...
        typePanel.add(batchModeCheckBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, -1, -1));

        batchConfigButton.setText("Configure");
        typePanel.add(batchConfigButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 210, -1, -1));
        ...
        textureMenuItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_T, java.awt.event.InputEvent.CTRL_MASK));
        textureMenuItem.setText("Texture");
        textureMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textureMenuItemActionPerformed(evt);
            }
        });
        openMenu.add(textureMenuItem);

        depthMapMenuItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.CTRL_MASK));
        depthMapMenuItem.setText("Depth Map");
        depthMapMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                depthMapMenuItemActionPerformed(evt);
            }
        });
        openMenu.add(depthMapMenuItem);
    ...
    /**
     * Modify this to add the batch option - texture pattern selection
     *
     * @param evt
     */
    ...
    /**
     * Moved the code to pick the texture pattern here so there could also be a
     * menu option
     */
    private void pickTexturePattern() {
    ...
    /**
     * Modify this to add the batch option - depth map selection
     *
     * @param evt
     */
    ...
    /**
     * Moved the code to pick the depth map here so there could also be a menu
     * option
     */
    private void pickDepthMap() {
    ...
    private void batchModeCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_batchModeCheckBoxActionPerformed
        ...
        batchMode = batchModeCheckBox.isSelected();
        if (batchMode) {
            mapFileChooser.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
            patternFileChooser.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
            mapFileChooser.setMultiSelectionEnabled(true);
            patternFileChooser.setMultiSelectionEnabled(true);
        } else {
            mapFileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
            patternFileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
            mapFileChooser.setMultiSelectionEnabled(false);
            patternFileChooser.setMultiSelectionEnabled(false);
        }
    }//GEN-LAST:event_batchModeCheckBoxActionPerformed

    //before modification, this did nothing
    ...
    private void licenseMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_licenseMenuItemActionPerformed
        new LicenseDialog(this, true).setVisible(true);
    ...
    /**
     * Calls method to pick the depth map from the menu
     * @param evt 
     */
    private void depthMapMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depthMapMenuItemActionPerformed
        pickDepthMap();
    }//GEN-LAST:event_depthMapMenuItemActionPerformed

    /**
     * Calls method to pick the texture pattern from the menu
     * @param evt 
     */
    private void textureMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textureMenuItemActionPerformed
        pickTexturePattern();
    }//GEN-LAST:event_textureMenuItemActionPerformed
    ...
    private javax.swing.JMenuItem depthMapMenuItem;
    ...
    private javax.swing.JMenuItem textureMenuItem;
